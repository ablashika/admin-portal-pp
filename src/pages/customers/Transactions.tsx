    ...
    const columns: GridColDef<(typeof initialRows)[number]>[] = [
        ...
        },
        {
            ...
            getActions: (params) => {
                ...
                if (debit === 'Failed' || debit === 'Authorization Pending' || credit === 'Failed' || credit === 'Authorization Pending') {
                    actions.push(
                        <GridActionsCellItem
                            icon={<EditIcon />}
                            label="Edit"
        ...
        <>
            <Header>
                <div className={`col-md-8 d-flex align-items-center justify-content-start ${mediaQueries.header_height}`}>
                    <h6 className='text-danger m-0'>Customers' Transactions</h6>
                </div>
            </Header>
                        ...
                        <div className="col-md-6 col-lg-3">
                            <div className="card py-3">
                                <div className="card-body d-flex flex-column justify-content-center align-items-center">
                                    ...
                                    <h5 className='card-text text-danger fs-3 fw-bold'>1234.00</h5>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-6 col-lg-3 mt-4 mt-md-0">
                            <div className="card py-3">
                                <div className="card-body d-flex flex-column justify-content-center align-items-center">
                                    ...
                                    <h5 className='card-text text-danger fs-3 fw-bold'>Gh&#8373; 134.00</h5>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-6 col-lg-3 mt-4 mt-md-4 mt-lg-0">
                            <div className="card py-3">
                                <div className="card-body d-flex flex-column justify-content-center align-items-center">
                                    ...
                                    <h5 className='card-text text-danger fs-3 fw-bold'>Gh&#8373; 123.00</h5>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-6 col-lg-3 mt-4 mt-md-4 mt-lg-0">
                            <div className="card py-3">
                                <div className="card-body d-flex flex-column justify-content-center align-items-center">
                                    ...
                                    <h5 className='card-text text-danger fs-3 fw-bold'>Gh&#8373; 34.00</h5>
                                </div>
                            </div>
                        </div>
                    </div>
