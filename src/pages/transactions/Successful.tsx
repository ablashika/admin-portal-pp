        ...
        <>
            <Header>
                <div className={`col-md-8 d-flex align-items-center justify-content-start ${mediaQueries.header_height}`}>
                    <h6 className='text-danger m-0'>Successful Transactions</h6>
                </div>
            </Header>
                        ...
                        <div className="col-sm-6">
                            <div className="card py-3">
                                <div className="card-body d-flex flex-column justify-content-center align-items-center">
                                    <p className="card-title fs-4">Successful Transactions</p>
                                    <h5 className='card-text text-danger fs-3 fw-bold'>1234</h5>
                                </div>
                            </div>
                        </div>
                        <div className="col-sm-6 mt-4 mt-md-0">
                            <div className="card py-3">
                                <div className="card-body d-flex flex-column justify-content-center align-items-center">
                                    ...
                                    <h5 className='card-text text-danger fs-3 fw-bold'>Gh&#8373; 1234.00</h5>
                                </div>
                            </div>
                        </div>
                    </div>
